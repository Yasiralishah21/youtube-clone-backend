...
//to generating referesh and access token 
...
const registerUser = asyncHandler( async (req, res) => {
    ...
    //.select by default selects all feilds so we only put the fields we want to remove.
...
const loginUser = asyncHandler(async (req, res) =>{ 
   ...
   if (!isPasswordValid) {
    ...
    //access and referesh token/sessionstorage = user dont have to write username password everytime
    //send cookie
...
const changeCurrentPassword = asyncHandler(async(req, res) => {
    ...
    //     throw new err("passwords didnt matched!!!")
    // }
